...
const marker = String.raw`<script src="home-reward-coordinator.js?v=5.4.22"><\/script>`;
const insertion = `${marker}${String.raw`<script src="daily-key-reward-priority-v1.js?v=1.0.0"><\/script>`}`;
