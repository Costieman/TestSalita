...
const js = fs.readFileSync("economy-tracking-phase6-v1.js","utf8");
...
new vm.Script(js,{filename:"economy-tracking-phase6-v1.js"});
...
if (!loader.includes("economy-tracking-phase6-v1.js?v=5.7.0")) fail("Phase 6 runtime is not loaded.");
